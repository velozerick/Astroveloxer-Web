...
<head>
    <meta charset="UTF-8">
    <title>Welcome to CodeIgniter 4! mira una modificacion</title>
...
<header>
    ...
    <div class="heroe">
        ...
        <h1>Welcome to CodeIgniter  JAJAJAA hola<?= CodeIgniter\CodeIgniter::CI_VERSION ?></h1>
